...
const API_URL = "https://25ed-102-88-34-41.ngrok-free.app/auth/register";
export default function App() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.smallText}>Register for the BOOK STORE</Text>
      <View
        style={{
          marginTop: 15,
          marginBottom: 40,
      ...
      {errors.password && <Text style={{ color: "#fff", marginTop: 5 }}></Text>}
